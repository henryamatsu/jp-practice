...
const CORRECTION_INSTRUCTION = `You are a helpful Japanese language tutor providing feedback on student answers.
...
;
;
const generateQuestionsDeclaration = {
...
class GeminiEngine {
    ...
    constructor(){
        ...
        this.client = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2f$genai$2f$dist$2f$node$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GoogleGenAI"]({
            apiKey
        });
    }
    /**
   ...
   */ getCorrectionSystemInstruction(topic, useJapanese) {
        let instruction = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prompts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CORRECTION_INSTRUCTION"];
        // Add Japanese text preference
        instruction += useJapanese ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prompts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LANGUAGE_DISPLAY_JAPANESE"] : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prompts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LANGUAGE_DISPLAY_ROMAJI"];
   ...
   */ getQuestionGenerationInstruction(topic, difficulty, useJapanese) {
        let instruction = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prompts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QUESTION_GENERATION_INSTRUCTION"];
        // Add Japanese text preference
        instruction += useJapanese ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prompts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LANGUAGE_DISPLAY_JAPANESE"] : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prompts$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["LANGUAGE_DISPLAY_ROMAJI"];
        // Add difficulty-specific instruction
        const difficultyConfig = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$topics$2e$json__$28$json$29$__["default"].difficulties[difficulty];
        if (difficultyConfig) {
   ...
   */ async generateQuestions(topic, difficulty, useJapanese, previousQuestions) {
        const actualTopic = topic === "random" ? this.getRandomTopic() : topic;
        const systemInstruction = this.getQuestionGenerationInstruction(actualTopic, difficulty, useJapanese);
            ...
            config: {
                ...
                toolConfig: {
                    functionCallingConfig: {
                        mode: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2f$genai$2f$dist$2f$node$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FunctionCallingConfigMode"].AUTO
                    }
                },
                tools: [
                    {
                        functionDeclarations: [
                            generateQuestionsDeclaration
                        ]
                    }
                ]
            }
   ...
   */ async generateResponse(messages, topic, useJapanese, currentQuestion, nextQuestion) {
        // If topic is random, pick a random topic for this session
        const actualTopic = topic === "random" ? this.getRandomTopic() : topic;
        const systemInstruction = this.getCorrectionSystemInstruction(actualTopic, useJapanese);
...
async function POST(request) {
    try {
        ...
        const { messages, topic, useJapanese, currentQuestion, nextQuestion } = body;
        const { text, actualTopic } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gemini$2d$engine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["geminiEngine"].generateResponse(messages, topic, useJapanese, currentQuestion, nextQuestion);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5b99c356._.js.map